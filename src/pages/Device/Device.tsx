    ...
    return (
        <Wrapper>
            ...
            <div className="flex">
                ...
                />
                <div className="m-[3rem] relative top-[5rem] w-[100%] h-fit flex flex-col sm:top-[5rem] bg-red-500 shadow-md rounded-md sm:m-[3rem]">
                    <button
                        onClick={() => {
                    ...
                    <div className="bg-yellow-500 w-[100%] border-[1px] grid grid-cols-3">
                    ...
                    <div className="text-[#1d4469] text-[20px] font-bold">JSON view</div>
                    <div className="text-[#7a7a7a] text-[12.5px]">View JSON data</div>
                    <div className=" w-[100%] flex flex-col bg-blue-500">
