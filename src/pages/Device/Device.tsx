    ...
    return (
        <Wrapper>
            ...
            <div className="flex">
                ...
                />
                <div className="m-[3rem] top-[5rem] w-[100%] flex flex-col sm:top-[5rem] rounded-md sm:m-[3rem]">
                    <button
                        onClick={() => {
                    ...
                    <div className="w-[100%] h-[1px] bg-[#f3f3f3]"></div>
                    <div className="gap-16 flex mt-4">
                    ...
                    <div className="w-[100%] flex h-[1px] bg-[#f3f3f3]"></div>
                        <div>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Totam laborum, eius veritatis voluptatum dignissimos quam distinctio cupiditate facilis iure eum aliquam temporibus autem nihil maiores architecto unde mollitia? Libero quis dolorem molestiae dolore totam. Iusto, culpa. Exercitationem harum, nobis assumenda perspiciatis laborum optio ut, quas dolore velit laudantium voluptatibus ratione unde eius officia repudiandae porro nam aliquam magnam. Sint quaerat voluptates maiores suscipit! Sit eaque, sunt tenetur mollitia iste rem assumenda? Nemo aperiam assumenda odio voluptatem, recusandae quo saepe voluptas rerum nisi fugiat iure libero harum veniam ipsa vero explicabo cum ea tenetur ipsum. Magnam suscipit cupiditate distinctio reprehenderit ex.</div>
