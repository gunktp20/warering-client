    ...
    return (
        <Wrapper >
            <div>
                ...
                <div className='mt-8'>
                    <Link to='/home' id="back-to-home-btn" className="px-9 py-2 text-[#45a2f9] capitalize rounded-md border-[#45a2f9] border-[2px] hover:bg-[#45a2f9] hover:text-white">back to home</Link>
                </div>
            </div>
        </Wrapper >
    )
