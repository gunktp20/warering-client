...
import { BigNavbar, Introduction, WeDoItem, Footer, SetupUserDrawer, SmallNavbar, AlertDialogSlide } from ".";
  ...
  return (
    <Wrapper>
      ...
      <div className="w-[100%] justify-center mt-[4.5rem] mb-[4.5rem] flex">
        <div className="w-[75%] flex justify-between items-center gap-5 bg-white lg:flex-col md:flex-col">
          {whatWeDo.length > 0
            &&
            whatWeDo.map((item) => {
              return (
