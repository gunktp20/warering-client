                        ...
                        >
                          ...
                          >
                            <div className="flex gap-3 items-center">
                              <img src={userAvatar} className="w-[31px] opacity-60 h-[31px] text-[#dbdbdb]"></img>
                              {user?.username}
                            </div>
                          </td>
                          <td className="p-3 text-[12.5px] text-[#878787] whitespace-nowrap text-left pl-28 sm:text-start">
                            <div className="font-bold hidden mr-3 sm:mb-2 sm:block text-gray-600">
                              Description{" "}
                            </div>
                            {user?.fname}
                            ...
                            <div className="flex justify-center sm:justify-start">
                              <button
                                className={`flex justify-center items-center text-white w-[100px] h-[28px] rounded-md transition-all ${
                                  user?.isActive ? "bg-green-500 hover:outline hover:outline-1 hover:outline-green-600 hover:shadow-md" : "bg-red-500 hover:outline hover:outline-1 hover:outline-red-600 hover:shadow-md"
                                }`}
                                onClick={() => {
